...
function setDarkMode(darkMode) {
	...
	appVariable.color.componentBg = (getComputedStyle(document.body).getPropertyValue('--app-component-bg')).trim();
	appVariable.color.componentBgRgb = (getComputedStyle(document.body).getPropertyValue('--app-component-bg-rgb')).trim();
	appVariable.color.componentColor = (getComputedStyle(document.body).getPropertyValue('--app-component-color')).trim();
	appVariable.color.componentColorRgb = (getComputedStyle(document.body).getPropertyValue('--app-component-color-rgb')).trim();
}
	...
	<div class="theme-panel" v-bind:class="{ 'active': appOption.appThemePanelToggled }">
		...
		<perfect-scrollbar class="theme-panel-content h-100">
			...
			<div class="theme-version">
				...
				<div class="theme-version-item">
					<a href="../template_vuejs/index.html" class="theme-version-link active">
