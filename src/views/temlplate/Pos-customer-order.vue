				...
				<perfect-scrollbar class="pos-content-container">
					<div class="product-row">
						<div class="product-container" data-type="meat">
							<a href="javascript:;" class="product" data-bs-toggle="modal" data-bs-target="#modalPosItem">
			...
			<div class="pos-sidebar" id="pos-sidebar">
				...
				<div class="pos-sidebar-nav">
					<ul class="nav nav-tabs nav-fill">
						<li class="nav-item">
							<a class="nav-link active" href="javascript:;" data-bs-toggle="tab" data-bs-target="#newOrderTab">New Order (5)</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="javascript:;" data-bs-toggle="tab" data-bs-target="#orderHistoryTab">Order History (0)</a>
						</li>
					</ul>
				</div>
				<perfect-scrollbar class="pos-sidebar-body tab-content h-100">
