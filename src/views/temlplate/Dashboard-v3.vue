...
<template>
	...
	<div class="d-sm-flex align-items-center mb-3">
		<a href="#" class="btn btn-dark me-10px text-truncate" id="daterange-filter">
			<i class="bi bi-calendar-event-fill text-white text-opacity-35 me-10px"></i>
			<span>1 March 2022 - 7 March 2022</span>
			<b class="caret ms-3 opacity-50"></b>
		</a>
		<div class="text-gray-600 fw-bold mt-2 mt-sm-0">compared to <span id="daterange-prev-date">24 Mar-30 Apr 2021</span></div>
	</div>
