	...
	methods: {
		...
		getChart2Data() {
			return {
				...
				datasets: [{
					...
					backgroundColor: 'rgba('+ appVariable.color.whiteRgb +', .2)' +', .5)',
		...
		getChart4Data() {
			return {
				datasets: [{
					data: [11, 16, 7, 3, 14],
					backgroundColor: ['rgba('+ appVariable.color.blueRgb +', .5)', 'rgba('+ appVariable.color.gray100Rgb +', .2)' +', .5)', 'rgba('+ appVariable.color.gray300Rgb +', .5)', 'rgba('+ appVariable.color.gray500Rgb +', .5)', 'rgba('+ appVariable.color.gray800Rgb +', .5)'],
					borderWidth: 0
				}],
		...
		getChart5Data() {
			return {
				...
				datasets: [{
					data: [300, 50, 100],
					backgroundColor: ['rgba('+ appVariable.color.blueRgb +', .5)', 'rgba('+ appVariable.color.gray500Rgb +', .2)' +', .5)', 'rgba('+ appVariable.color.blueRgb +', .5)'],
					hoverBackgroundColor: ['rgba('+ appVariable.color.blueRgb +', 1)', 'rgba('+ appVariable.color.gray500Rgb +', 1)', 'rgba('+ appVariable.color.gray900Rgb +', 1)'],
					borderWidth: 0
				}]
			};
		},
		getChart6Data() {
			return {
				...
				datasets: [{
					data: [300, 50, 100],
					backgroundColor: ['rgba('+ appVariable.color.blueRgb +', .5)', 'rgba('+ appVariable.color.gray500Rgb +', .2)' +', .5)', 'rgba('+ appVariable.color.blueRgb +', .5)'],
					hoverBackgroundColor: [appVariable.color.blue, appVariable.color.gray500, appVariable.color.gray900],
					borderWidth: 0
				}]
			};
		}
	...
	<div>
			...
			<div class="col-xl-6">
				...
				<panel>
					...
					<panel-body>
						...
						<div class="h-250px">
							<chartjs :type="chart1.type" :data="chart1.data" :options="chart1.options" />
						</div>
					</panel-body>
			...
			<div class="col-xl-6">
				...
				<panel>
					...
					<panel-body>
						...
						<div class="h-250px">
							<chartjs :type="chart2.type" :data="chart2.data" :options="chart2.options" />
						</div>
					</panel-body>
		...
		<div class="row">
			...
			<div class="col-xl-6">
				...
				<panel>
					...
					<panel-body>
						...
						<div class="h-250px">
							<chartjs :type="chart3.type" :data="chart3.data" :options="chart3.options" />
						</div>
					</panel-body>
			...
			<div class="col-xl-6">
				...
				<panel>
					<panel-header>
						<panel-title>Polar Area Chart</panel-title>
						<panel-toolbar />
					</panel-header>
					<panel-body>
						<p>
						...
						<div class="h-250px">
							<chartjs :type="chart5.type" :data="chart4.data" :options="chart4.options" />
						</div>
					</panel-body>
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<panel>
					...
					<panel-body>
						...
						<div class="h-250px">
							<chartjs :type="chart5.type" :data="chart5.data" :options="chart5.options" />
						</div>
					</panel-body>
			...
			<div class="col-md-6">
				...
				<panel>
					<panel-header>
						<panel-title>Doughnut Chart</panel-title>
						<panel-toolbar />
					</panel-header>
					<panel-body>
						<p>
						...
						<div class="h-250px">
							<chartjs :type="chart6.type" :data="chart6.data" :options="chart6.options" />
						</div>
					</panel-body>
