...
export default {
	...
	methods: {
		handleChangeWidgetTheme: function() {
		...
		getVisitorData() {
			return {
				chart: {
					...
					options: {
						colors: [appVariable.color.red, appVariable.color.orange],
						fill: {
							opacity: .75,
							type: 'solid'
						},
						...
						grid: { 
							show: true, borderColor: 'rgba('+ appVariable.color.componentColorRgb +', .15)',
							xaxis: {
								lines: {
									show: true
								}
...
<template>
	...
	<span class="btn-group float-end ms-20px p-2px bg-black bg-opacity-20 rounded">
		<a href="javascript:;" class="btn btn-sm btn-white border-0" v-on:click.prevent="handleChangeWidgetTheme()" v-bind:class="{ 'active': !darkMode }"><i class="fa fa-sun text-blue"></i> Light</a>
		<a href="javascript:;" class="btn btn-sm btn-white border-0" v-on:click.prevent="handleChangeWidgetTheme()" v-bind:class="{ 'active': darkMode }"><i class="fa fa-moon"></i> Dark</a>
	</span>
	<p class="mb-20px">
	...
	<div class="row">
			...
			<div class="row">
				...
				<div class="col-xl-12 col-lg-6">
					...
					<div class="mb-10px mt-10px fs-10px">
						...
						<b class="text-dark">WIDGET LIST</b>
					</div>
					<div class="widget-list rounded mb-4" v-bind:class="{'dark-mode': darkMode}">
				...
				<div class="col-xl-12 col-lg-6">
					...
					<div class="mb-10px mt-10px fs-10px">
						...
						<b class="text-dark">WIDGET LIST WITH ICON</b>
					</div>
					<div class="widget-list rounded mb-4" v-bind:class="{'dark-mode': darkMode}">
				...
				<div class="col-xl-12 col-lg-6">
					...
					<div class="mb-10px mt-10px fs-10px">
						...
						<b class="text-dark">WIDGET CHAT</b>
					</div>
					<div class="widget-chat rounded mb-4" v-bind:class="{'dark-mode': darkMode}">
						...
						<perfect-scrollbar class="widget-chat-body h-250px">
				...
				<div class="col-xl-12 col-lg-6">
					...
					<div class="mb-10px mt-10px fs-10px">
						...
						<b class="text-dark">WIDGET TODOLIST</b>
					</div>
					<div class="widget-todolist rounded mb-4" v-bind:class="{'dark-mode': darkMode}">
				...
				<div class="col-xl-12 col-lg-6">
					...
					<div class="mb-10px mt-10px fs-10px">
						...
						<b class="text-dark">WIDGET MAP</b>
					</div>
					<div class="widget-map rounded mb-4" v-bind:class="{'dark-mode': darkMode}">
						...
						<div class="widget-map-list" v-bind:class="{'dark-mode': darkMode}">
		...
		<div class="col-lg-12 col-xl-8">
			<div class="mb-10px mt-10px fs-10px">
				...
				<b class="text-dark">WIDGET IMAGE / ICON</b>
			</div>
			<!-- BEGIN row -->
			<div class="row mb-4">
				<!-- BEGIN col-6 -->
			...
			<div class="mb-10px mt-10px fs-10px">
				...
				<b class="text-dark">WIDGET CARD</b>
			</div>
			<!-- BEGIN row -->
			<div class="row">
				<!-- BEGIN col-6 -->
				<div class="col-sm-6">
					<!-- BEGIN widget-card -->
					<a href="#" class="widget-card rounded mb-20px" v-bind:class="{'dark-mode': darkMode}">
					...
					<a href="#" class="widget-card rounded mb-20px" v-bind:class="{'dark-mode': darkMode}">
						...
						<div class="widget-card-content">
							<h5 class="fs-12px text-black text-opacity-75" data-id="widget-elm"
								...
								data-dark-class="fs-12px text-white text-opacity-75"><b>MAKING A DIFFERENCE</b></h5>
						...
						<div class="widget-card-content bottom">
							<b class="text-black text-opacity-75" data-id="widget-elm"
								data-light-class="fs-12px text-black text-opacity-75"
								data-dark-class="fs-12px text-white text-opacity-75">Opt in and help heart research.</b>
						</div>
					</a>
					<!-- END widget-card -->
				</div>
			...
			<div class="mb-10px mt-10px fs-10px">
				...
				<b class="text-dark">WIDGET CARD SQUARE</b>
			</div>
			<!-- BEGIN row -->
			<div class="row">
				<!-- BEGIN col-3 -->
						...
						<div class="widget-card-cover" style="background-image: url(/assets/img/login-bg/login-bg-10-thumb.jpg)">
							<div class="d-flex h-100 align-items-center justify-content-center">
								<div class="text-center">
									...
									<div class="text-white text-opacity-75 fw-bold">2022</div>
								</div>
							</div>
						</div>
					</a>
					<div class="fs-12px fw-bold text-black pt-2px">Memory 2022</div>
			...
			<div class="mb-10px mt-10px fs-10px">
				...
				<b class="text-dark">WIDGET STAT</b>
			</div>
			<!-- BEGIN row -->
			...
			<div class="mb-10px mt-10px fs-10px">
				...
				<b class="text-dark">WIDGET CHART</b>
			</div>
			<!-- BEGIN widget-chart -->
			<div class="widget rounded mb-4" v-bind:class="{'dark-mode': darkMode}">
				<!-- BEGIN widget-header -->
				...
				<div class="row m-0">
					<div class="col widget-chart-content">
						<apexchart type="bar" width="100%" height="350px" :options="visitorData.chart.options" :series="visitorData.chart.series"></apexchart>
					</div>
			...
			<div class="mb-10px mt-10px fs-10px">
				...
				<b class="text-dark">WIDGET TABLE</b>
			</div>
			<!-- BEGIN widget-table -->
			<div class="table-responsive">
				<!-- BEGIN widget-table -->
				<table class="table table-bordered widget-table rounded" v-bind:class="{'dark-mode': darkMode}">
					<thead>
						...
						<tr>
							...
							<td>
								...
								<div class="clearfix fs-10px">
									status: 
									<b class="text-dark" data-id="widget-elm" 
										data-light-class="text-dark" 
							...
							<td class="text-nowrap">
								...
								<small class="text-dark" data-id="widget-elm" 
									data-light-class="text-dark" 
							...
							<td>999.00</td>
							<td>
								<a href="#" class="btn btn-dark btn-sm w-80px rounded-pill" data-id="widget-elm"
									data-light-class="btn btn-dark btn-sm w-80px rounded-pill"
	...
	<div class="modal fade" id="modal-widget-list">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<!-- BEGIN hljs-wrapper -->
				<highlightjs :code="code1" class="mb-0" />
				<!-- END hljs-wrapper -->
	...
	<div class="modal fade" id="modal-widget-list-with-icon">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<!-- BEGIN hljs-wrapper -->
				<highlightjs :code="code2" class="mb-0" />
				<!-- END hljs-wrapper -->
				<div class="modal-footer">
					<a href="#" data-bs-dismiss="modal" class="btn btn-default">Close</a>
				</div>
	...
	<div class="modal fade" id="modal-widget-chat-input">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<!-- BEGIN hljs-wrapper -->
				<highlightjs :code="code3" class="mb-0" />
				<!-- END hljs-wrapper -->
				<div class="modal-footer">
					<a href="#" data-bs-dismiss="modal" class="btn btn-default">Close</a>
				</div>
	...
	<div class="modal fade" id="modal-widget-todolist">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<!-- BEGIN hljs-wrapper -->
				<highlightjs :code="code4" class="mb-0" />
				<!-- END hljs-wrapper -->
				<div class="modal-footer">
					<a href="#" data-bs-dismiss="modal" class="btn btn-default">Close</a>
				</div>
	...
	<div class="modal fade" id="modal-widget-map">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<!-- BEGIN hljs-wrapper -->
				<highlightjs :code="code5" class="mb-0" />
				<!-- END hljs-wrapper -->
				<div class="modal-footer">
					<a href="#" data-bs-dismiss="modal" class="btn btn-default">Close</a>
				</div>
	...
	<div class="modal fade" id="modal-widget-img-icon">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<!-- BEGIN hljs-wrapper -->
				<highlightjs :code="code6" class="mb-0" />
				<!-- END hljs-wrapper -->
				<div class="modal-footer">
					<a href="#" data-bs-dismiss="modal" class="btn btn-default">Close</a>
				</div>
	...
	<div class="modal fade" id="modal-widget-card">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<!-- BEGIN hljs-wrapper -->
				<highlightjs :code="code7" class="mb-0" />
				<!-- END hljs-wrapper -->
				<div class="modal-footer">
					<a href="#" data-bs-dismiss="modal" class="btn btn-default">Close</a>
				</div>
	...
	<div class="modal fade" id="modal-widget-card-square">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<!-- BEGIN hljs-wrapper -->
				<highlightjs :code="code8" class="mb-0" />
				<!-- END hljs-wrapper -->
				<div class="modal-footer">
					<a href="#" data-bs-dismiss="modal" class="btn btn-default">Close</a>
				</div>
	...
	<div class="modal fade" id="modal-widget-stat">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<!-- BEGIN hljs-wrapper -->
				<highlightjs :code="code9" class="mb-0" />
				<!-- END hljs-wrapper -->
				<div class="modal-footer">
					<a href="#" data-bs-dismiss="modal" class="btn btn-default">Close</a>
				</div>
	...
	<div class="modal fade" id="modal-widget-chart">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<!-- BEGIN hljs-wrapper -->
				<highlightjs :code="code10" class="mb-0" />
				<!-- END hljs-wrapper -->
				<div class="modal-footer">
					<a href="#" data-bs-dismiss="modal" class="btn btn-default">Close</a>
				</div>
	...
	<div class="modal fade" id="modal-widget-table">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<!-- BEGIN hljs-wrapper -->
				<highlightjs :code="code11" class="mb-0" />
				<!-- END hljs-wrapper -->
				<div class="modal-footer">
					<a href="#" data-bs-dismiss="modal" class="btn btn-default">Close</a>
				</div>
